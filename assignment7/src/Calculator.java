...
/**
 * This class implements a calculator using the java swig libraries
 * 
 * 
 * @author Preet LNU
 * @version 5-09-2022
...
public class Calculator extends JFrame 
{
    ...
    public Calculator() 
    {
        ...
        //adding the menu bar with Operations like add, sub, muli, div, and clear
        ...
        JMenuItem menuItem3 = new JMenuItem("multiplication");
        JMenuItem menuItem4 = new JMenuItem("division");
        ...
        //adding images to the operator buttons
        ...
        Icon iconAdd = new ImageIcon(this.getClass().getResource("add (2).png"));
        plusSign = new JButton(iconAdd);
        
        Icon iconSub = new ImageIcon(this.getClass().getResource("subtract (1).png"));
        minusSign = new JButton(iconSub);
        
        Icon iconMult = new ImageIcon(this.getClass().getResource("multiply.png"));
        multSign = new JButton(iconMult);
        
        Icon iconDiv = new ImageIcon(this.getClass().getResource("division.png"));
        divSign = new JButton(iconDiv);
        
        Icon iconEqual = new ImageIcon(this.getClass().getResource("equal.png"));
        eqSign = new JButton(iconEqual);
